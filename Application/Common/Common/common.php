...
function sendSMS($mobile, $code)
{
    ...
    $params["SignName"] = $config['sms_product'];
    ...
    vendor('Alidayu2.SignatureHelper');
 ...
 * 获取用户地址列表
 */
function get_user_my_list($user_id){
    $my_list = M('user_my')->where(array('user_id'=>$user_id))->select();
    return $my_list;
}
